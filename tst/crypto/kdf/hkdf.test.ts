...
import { expand, extract } from '../../../src/crypto/kdf/Hkdf';
import { hkdf } from '../../../src/crypto/kdf';
import { Sha1, Sha256 } from '../../../src/crypto/hash';
...
tsts(`extract`, () => {
	...
	assert.is(
		hex.fromBytes(
			extract(
				hash,
				hex.toBytes('0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b'),
				undefined
			)
		),
...
tsts(`expand`, () => {
	...
	assert.is(
		hex.fromBytes(
			expand(
				hash,
				hex.toBytes('DA8C8A73C7FA77288EC6F5E7C297786AA0D32D01'),
				42,
				undefined
			)
		),

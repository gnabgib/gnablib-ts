...
export function toDense2(d0: number, d1: number): number {
	somewhatSafe.uint.atMost('d0', d0, 9);
	somewhatSafe.uint.atMost('d1', d1, 9);
...
export function fromDense3(value: number): bcd {
	somewhatSafe.uint.atMost('value', value, 0x3ff);
...
export function toDense3(d0: number, d1: number, d2: number): number {
	somewhatSafe.uint.atMost('d0', d0, 9);
	somewhatSafe.uint.atMost('d1', d1, 9);
	somewhatSafe.uint.atMost('d2', d2, 9);
...
export function push2DigitsToBytes(
	...
	somewhatSafe.uint.atMost('value', value, 99);
	const packBits = 7;
...
export function push3DigitsToBytes(
	...
	somewhatSafe.uint.atMost('value', value, 999);
	const packBits = 10;
	const startBitPos = bitPos & 0x7;
	const bytePos = bitPos >> 3;
	const d2 = value % 10;

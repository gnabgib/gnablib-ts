 ...
 * random generator, known as [MINSTD](https://oeis.org/A096550) or MCG16807 from 1988
 *
...
/**
 * Build a [Lehmer](https://en.wikipedia.org/wiki/Lehmer_random_number_generator)
 * random generator, known as (MINSTD2)[https://oeis.org/A221556] or MCG48271 from 1990
 *
...
// 	/** Get the next random number */
// 	return () => {
//         s = U64.fromInt(s).mul(U64.fromInt(mul)).add(U64.fromInt(add)).mod(U64.fromInt(mod))
// 		s = (s * mul + add) % mod;//2147483647
// 		return s;
// 	};
// }
...
//  * @returns function to produce integers in the range 0 - 2147483647
//  */
// export function MCG62089911(seed=1):IRandInt { return lcg32(seed,62089911,0,0x7fffffff); }

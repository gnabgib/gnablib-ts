 ...
 * @private
 */
export abstract class APrng32 {
	/** How many bits are generated by rawNext */
	abstract get bitGen(): number;
	/** Maximum value that {@link this.rawNext} may generate */
	get max(): number {
		return Math.pow(2, this.bitGen) - 1;
	}
	/**
	 * Generate the next number in the sequence, be aware of {@link this.max} if you intend to use this value
	 ...
	 * which is the same as the positive range of an int32
	 * @returns
	 */

...
const blockSize = 16;
const rounds = 32;
const fk = Uint32Array.of(0xa3b1bac6, 0x56aa3350, 0x677d9197, 0xb27022dc);
// prettier-ignore
const ck=Uint32Array.of(
 ...
 *
 * Specified in:
 * - [ISO/IEC 18033-3:2010](https://www.iso.org/standard/81564.html)
 * - [IETF draft-ribose-cfrg-sm4-10](https://datatracker.ietf.org/doc/html/draft-ribose-cfrg-sm4-10)
 */
export class Sm4 implements IBlockCrypt {
	/** Block size in bytes */
	...
	constructor(key: Uint8Array) {
		const k2 = key.slice();
		const k32 = new Uint32Array(k2.buffer, k2.byteOffset, k2.length / 4);
		asBE.i32(k2, 0, 4);
		///*DBUG*/uLog32(k32);

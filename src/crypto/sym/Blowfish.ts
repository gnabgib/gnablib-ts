...
// prettier-ignore
/** permutation array - initial values: the hexadecimal digits of pi (less the initial 3) */
const pArr = Uint32Array.of(
 ...
 * {@link crypto.Aes | Advanced Encryption Standard (AES)} now receives more attention, and Schneier recommends
 * {@link crypto.Twofish | Twofish} for modern applications.
 *
...
export class Blowfish implements IBlockCrypt {
	...
	/** substitution box 1 */
	private readonly _s1 = sBox1.slice();
	/** substitution box 2 */
	private readonly _s2 = sBox2.slice();
	/** substitution box 3 */
	private readonly _s3 = sBox3.slice();
	...
	private init(key: Uint8Array): void {
		sLen('key', key).atLeast(minKeyLen).atMost(maxKeyLen).throwNot();

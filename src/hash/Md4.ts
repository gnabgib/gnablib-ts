...
export function md4(bytes: Uint8Array): Uint8Array {
	...
	for (let i = 0; i < padBytes.length; i += blockSizeBytes) {
		...
		v[0] = bitExt.rotLeft32(
			v[0] + (v[3] ^ (v[1] & (v[2] ^ v[3]))) + x[0],
			round0col0
		);
		v[3] = bitExt.rotLeft32(
			v[3] + (v[2] ^ (v[0] & (v[1] ^ v[2]))) + x[1],
			round0col1
		);
		v[2] = bitExt.rotLeft32(
			v[2] + (v[1] ^ (v[3] & (v[0] ^ v[1]))) + x[2],
			round0col2
		);
		v[1] = bitExt.rotLeft32(
			v[1] + (v[0] ^ (v[2] & (v[3] ^ v[0]))) + x[3],
			round0col3
		);
		v[0] = bitExt.rotLeft32(
			v[0] + (v[3] ^ (v[1] & (v[2] ^ v[3]))) + x[4],
			round0col0
		);
		v[3] = bitExt.rotLeft32(
			v[3] + (v[2] ^ (v[0] & (v[1] ^ v[2]))) + x[5],
			round0col1
		);
		v[2] = bitExt.rotLeft32(
			v[2] + (v[1] ^ (v[3] & (v[0] ^ v[1]))) + x[6],
			round0col2
		);
		v[1] = bitExt.rotLeft32(
			v[1] + (v[0] ^ (v[2] & (v[3] ^ v[0]))) + x[7],
			round0col3
		);
		v[0] = bitExt.rotLeft32(
			v[0] + (v[3] ^ (v[1] & (v[2] ^ v[3]))) + x[8],
			round0col0
		);
		v[3] = bitExt.rotLeft32(
			v[3] + (v[2] ^ (v[0] & (v[1] ^ v[2]))) + x[9],
			round0col1
		);
		v[2] = bitExt.rotLeft32(
			v[2] + (v[1] ^ (v[3] & (v[0] ^ v[1]))) + x[10],
			round0col2
		);
		v[1] = bitExt.rotLeft32(
			v[1] + (v[0] ^ (v[2] & (v[3] ^ v[0]))) + x[11],
			round0col3
		);
		v[0] = bitExt.rotLeft32(
			v[0] + (v[3] ^ (v[1] & (v[2] ^ v[3]))) + x[12],
			round0col0
		);
		v[3] = bitExt.rotLeft32(
			v[3] + (v[2] ^ (v[0] & (v[1] ^ v[2]))) + x[13],
			round0col1
		);
		v[2] = bitExt.rotLeft32(
			v[2] + (v[1] ^ (v[3] & (v[0] ^ v[1]))) + x[14],
			round0col2
		);
		v[1] = bitExt.rotLeft32(
			v[1] + (v[0] ^ (v[2] & (v[3] ^ v[0]))) + x[15],
			round0col3
		);
		...
		v[0] = bitExt.rotLeft32(
			v[0] + (v[1] ^ v[2] ^ v[3]) + x[0] + round3Add,
			round2col0
		);
		v[3] = bitExt.rotLeft32(
			v[3] + (v[0] ^ v[1] ^ v[2]) + x[8] + round3Add,
			round2col1
		);
		v[2] = bitExt.rotLeft32(
			v[2] + (v[3] ^ v[0] ^ v[1]) + x[4] + round3Add,
			round2col2
		);
		v[1] = bitExt.rotLeft32(
			v[1] + (v[2] ^ v[3] ^ v[0]) + x[12] + round3Add,
			round2col3
		);
		v[0] = bitExt.rotLeft32(
			v[0] + (v[1] ^ v[2] ^ v[3]) + x[2] + round3Add,
			round2col0
		);
		v[3] = bitExt.rotLeft32(
			v[3] + (v[0] ^ v[1] ^ v[2]) + x[10] + round3Add,
			round2col1
		);
		v[2] = bitExt.rotLeft32(
			v[2] + (v[3] ^ v[0] ^ v[1]) + x[6] + round3Add,
			round2col2
		);
		v[1] = bitExt.rotLeft32(
			v[1] + (v[2] ^ v[3] ^ v[0]) + x[14] + round3Add,
			round2col3
		);
		v[0] = bitExt.rotLeft32(
			v[0] + (v[1] ^ v[2] ^ v[3]) + x[1] + round3Add,
			round2col0
		);
		v[3] = bitExt.rotLeft32(
			v[3] + (v[0] ^ v[1] ^ v[2]) + x[9] + round3Add,
			round2col1
		);
		v[2] = bitExt.rotLeft32(
			v[2] + (v[3] ^ v[0] ^ v[1]) + x[5] + round3Add,
			round2col2
		);
		v[1] = bitExt.rotLeft32(
			v[1] + (v[2] ^ v[3] ^ v[0]) + x[13] + round3Add,
			round2col3
		);
		v[0] = bitExt.rotLeft32(
			v[0] + (v[1] ^ v[2] ^ v[3]) + x[3] + round3Add,
			round2col0
		);
		v[3] = bitExt.rotLeft32(
			v[3] + (v[0] ^ v[1] ^ v[2]) + x[11] + round3Add,
			round2col1
		);
		v[2] = bitExt.rotLeft32(
			v[2] + (v[3] ^ v[0] ^ v[1]) + x[7] + round3Add,
			round2col2
		);
		v[1] = bitExt.rotLeft32(
			v[1] + (v[2] ^ v[3] ^ v[0]) + x[15] + round3Add,
			round2col3
		);

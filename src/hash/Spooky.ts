...
export class SpookyShort extends ASpooky {
	...
	private hash(): void {
		...
		//console.log(`smix: ${hex.fromU64a(this.#state,' ')}`);
		...
		//console.log(`smi2: ${hex.fromU64a(this.#state,' ')}`);
		this.#bPos = 0;
	}
	private final(): void {
		//Make sure block is little-endian
		...
		this.#state.at(2).addEq(this.#block64.at(2));
		this.#state.at(3).addEq(this.#block64.at(3));
		//console.log(`send: ${hex.fromU64a(this.#state,' ')}`);
		...
		//console.log(`sfin: ${hex.fromU64a(this.#state,' ')}`);
	}
...
export class SpookyLong extends ASpooky {
	...
	private hash(): void {
		...
		//console.log(`lmi0: ${hex.fromU64a(this.#state,' ')}`);
		...
		//console.log(`lmix: ${hex.fromU64a(this.#state,' ')}`);
		this.#bPos = 0;
	}
	private finalPartial(): void {
		...
		//console.log(`lfp: ${hex.fromU64a(this.#state,' ')}`);
	}
	private final(): void {
		//Make sure block is little-endian
		asLE.i64(this.#block, 0, lBlockSizeEls);
		...
		this.#state.at(10).addEq(this.#block64.at(10));
		this.#state.at(11).addEq(this.#block64.at(11));
		//console.log(`lfi: ${hex.fromU64a(this.#state,' ')}`);
		//Three times a lady
		this.finalPartial();
		this.finalPartial();
		this.finalPartial();

		//console.log(`lfin: ${hex.fromU64a(this.#state,' ')}`);
	}

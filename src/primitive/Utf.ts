...
export const utf = {
	 ...
	 * @returns
	 */
	lineBreak: function (ord: number | string): boolean {
	 ...
	 * @returns
	 */
	whiteSpace: function (ord: number | string): boolean {
		if (typeof ord === 'string') {
			ord = ord.charCodeAt(0);
		}
	 ...
	 * @returns
	 */
	printable: function (ord: number | string): boolean {
		if (typeof ord === 'string') {
			ord = ord.charCodeAt(0);
		}
		//C0
	 ...
	 * @returns
	 */
	asciiCased: function (ord: number | string): boolean {
		if (typeof ord === 'string') {
			ord = ord.charCodeAt(0);
		}

...
export type { IReadArray } from './IReadArray.js';
export type { IReadTyped } from './IReadTyped.js';
export type { IReadWriteArray } from './IReadWriteArray.js';
export type { ISerializer } from './ISerializer.js';
export type { IValueMerge } from './IValueMerge.js';
export type { IWriteTyped } from './IWriteTyped.js';

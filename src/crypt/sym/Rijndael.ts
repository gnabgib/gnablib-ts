...
// prettier-ignore
/** Substitution box used in SubBytes (FIPS-197 fig 7) */
...
// prettier-ignore
/** Substitution box used in (FIPS-197 fig 14) */
...
export class Aes implements ICrypt {
	...
	/** Byte state */
	readonly #s8:Uint8Array;
	/** U32 state (shared memory with #s8) */
	readonly #s32:Uint32Array;

    constructor(key:Uint8Array) {
        this.#key=key;
		// Nb=4 (128/32)
		this.#s8=new Uint8Array(16);
		this.#s32=new Uint32Array(this.#s8.buffer);
    }

...
import { Bin1, Bin2, Bin3, Bin4ish } from './Bin';
import { Bool } from './Bool';
import { ColType } from './ColType';
import type { ACudColType } from './CudColType';
import { DateTimeCol } from './DateTime';
import { Float4, Float8 } from './Float';
import { Id2, Id4, Id8 } from './Id';
import { Int2, Int4, Int8 } from './Int';
import { Ref2 } from './Ref';
import { Utf81, Utf82, Utf83, Utf84ish } from './Utf8';

const nullMarker = 0x80;

export function cudColTypeFromBin(bin:Uint8Array,pos=0):FromBinResult<ACudColType> {
    const byte = bin[pos];
        ...
        return new FromBinResult<ACudColType>(0,undefined,`cudColTypeFromBin unknown colType ${c}`);
}
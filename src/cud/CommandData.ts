...
export class CmdDataInsert extends ADataCols {
	...
	static Now(
		...
		return new CmdDataInsert(userId, OldDateTime.now(), table, recId, ...cols);
	}
...
export class CmdDataPut extends ADataCols {
	...
	static Now(
		...
		return new CmdDataPut(userId, OldDateTime.now(), table, recId, ...cols);
	}
...
export class CmdDataPatch extends ADataCols {
	...
	static Now(
		...
		return new CmdDataPatch(userId, OldDateTime.now(), table, recId, ...cols);
	}
...
export class CmdDataDelete extends ACmdData {
	...
	static Now(userId: number, table: TableName, recId: number): CmdDataDelete {
		return new CmdDataDelete(userId, OldDateTime.now(), table, recId);
	}

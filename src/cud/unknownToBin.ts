...
import { uintToScaleBytes } from '../primitive/IntExt';
import * as Utf8 from '../encoding/Utf8';
import { fp64ToBytes } from '../encoding/ieee754-fp64';
import { Uint64 } from '../primitive/Uint64';
import { intToMinBytes, uintToMinBytes } from '../endian/big';
...
export function unknownFromBin(bin:Uint8Array,pos:0):FromBinResult<unknown> {
	const l=bin[pos];

...
export class CmdCtrlCreate extends ACmdCtrl {
	...
	static Now(
		...
		return new CmdCtrlCreate(userId, DateTimeLocal.now(), table, ...cols);
	}
...
export class CmdCtrlRemCols extends ACmdCtrl {
	...
	static Now(
		...
		return new CmdCtrlRemCols(userId, DateTimeLocal.now(), table, ...cols);
	}
...
export class CmdCtrlDrop extends ACmdCtrl {
	public constructor(userId: number, started: DateTimeLocal, table: TableName) {
		super(userId, started, table, CommandCtrl.Drop);
	}

	static Now(userId: number, table: TableName): CmdCtrlDrop {
		return new CmdCtrlDrop(userId, DateTimeLocal.now(), table);
	}
